...
export const useAnonymousEmailStore = defineStore('anonymousEmails',()=>{
    ...
    users.value.MATH_TEACHER = ANONYMOUS_EMAIL_DEFAULTS.MATH_TEACHER;
    users.value.DRAMA_TEACHER = ANONYMOUS_EMAIL_DEFAULTS.DRAMA_TEACHER;
    users.value.MUSIC_TEACHER = ANONYMOUS_EMAIL_DEFAULTS.MUSIC_TEACHER;
    users.value.LIBRARY_TEACHER = ANONYMOUS_EMAIL_DEFAULTS.LIBRARY_TEACHER;
