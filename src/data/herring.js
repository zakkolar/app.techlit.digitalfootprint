...
export const Herring = user => {
    ...
    return [
        ...
        new Search('school prank ideas', user, "9:10 AM", -1),
        new Visit('Top 10 School Pranks', {minutes: 10}, user, "9:15 AM", -1),
        new DriveCreate('School Pranks', DriveDocument.DOC_TYPES.DOC, user, "9:26 AM", -1),
...
...`, 'School Pranks', DriveDocument.DOC_TYPES.DOC, user, "9:27 AM", -1),
        ...
        I made a <span class='underline text-blue-600'>list of popular pranks</span> to watch out for. Keep an eye out for suspicious activity.`, user, "9:32 AM", -1),

        new Search('how to send an anonymous email', user, "10:37 AM", -1),
        new Visit('Anonymous emails: A very technical task', {minutes: 1}, user, "10:38 AM", -1),

         new Email('[all-teachers]', 'Stumped', `Hi all,
        The pranks seem to have started. You might have seen an anonymous email. I tried to figure out how they sent the message, but I couldn't understand the instructions I found. I will keep looking.`, user, "10:43 am", -1),

        new Search('dinner recipes', user, "11:40 AM", -1),
        new Visit('Pickled Red Herring Recipe', {minutes: 2}, user, "11:41 AM", -1),
